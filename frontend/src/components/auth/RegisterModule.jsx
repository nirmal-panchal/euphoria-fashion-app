      ...
      <div className='px-24 py-16 w-1/2'>
        ...
        <form>
          <div className='flex flex-col pb-7'>
            ...
            <input type="text" className="text-darkGray border border-blackGray rounded-lg py-4 px-5" />
          </div>
          <div className='flex flex-col pb-7'>
            ...
            <input type="password" className="text-darkGray mb-2 border border-blackGray rounded-lg py-4 px-5" />
            {/* <Link href="#" className='text-end text-sm underline'>Forget your password?</Link> */}
          </div>
          <button className='py-4 px-14 bg-brightPurple text-white font-medium rounded-lg mb-2'>Sign Up</button>
