      ...
      <div className='px-24 py-16 w-1/2'>
        ...
        <form>
          <div className='flex flex-col pb-7'>
            ...
            <input type="text" className="border border-[#3C4242] rounded-lg py-4 px-5" />
          </div>
          <div className='flex flex-col pb-7'>
            ...
            <input type="password" className="mb-2 border border-[#3C4242] rounded-lg py-4 px-5" />
            <Link href="/auth/forgetpassword" className='text-end text-sm underline'>Forget your password?</Link>
          </div>
          <button className='py-4 px-14 bg-[#8A33FD] text-white font-medium rounded-lg mb-2'>Sign In</button>
