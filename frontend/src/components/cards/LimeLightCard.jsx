    ...
    return (
        <div className='max-w-fit'>
            <div className='relative w-[270px] h-96 mb-4'>
                ...
                <div className='absolute top-6 left-[220px] bg-[#FFFFFF] text-blackGray rounded-full p-2'>
                    <IoMdHeartEmpty />
                </div>
            </div>
            <div className='flex justify-between'>
                ...
                <div className='bg-extraLightGray h-fit py-2 px-4 font-bold text-sm rounded-lg'>
                    $ {price}
                </div>
            </div>
        </div>
